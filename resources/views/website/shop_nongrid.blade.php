...
<section class="products_page">
         ...
         <div class="category_sidebar">
            ...
            <hr>
            <a href="https://askbootstrap.com/preview/osahan-fashion/shop-grid-left-sidebar.html">
            <img class="rounded" src="https://askbootstrap.com/preview/osahan-fashion/images/offers/kids-top.png" alt="Bannar 1">
            </a>
            <hr>
            <a href="https://askbootstrap.com/preview/osahan-fashion/shop-grid-left-sidebar.html">
            <img class="rounded" src="https://askbootstrap.com/preview/osahan-fashion/images/offers/home2_banner_2.jpg" alt="Bannar 1">
            </a>
            </div>
            ...
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/list-slider/slider1.jpg" alt="First slide"></a>
            </div>
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/list-slider/slider2.jpg" alt="First slide"></a>
            </div>
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/list-slider/slider3.jpg" alt="First slide"></a>
            </div>
            </div>	
            </div>
            ...
            <a  href="{{route('shop')}}"> <i class="fa fa-th-large"></i> </a><a class="active" href="{{route('shop.nongrid')}}"> <i class="fa fa-th-list"></i> </a>
            </div>
            ...
            <div class="col-lg-6 col-md-6"><div class="item">
            <div class="h-100">
            ...
            </div></div><div class="col-lg-6 col-md-6"><div class="item">
            <div class="h-100">
            <div class="product-item product-item-list">
