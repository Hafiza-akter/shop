               ...
               <div class="shop-detail-left">
                  <div class="item-img-grid">
                     ...
                     <div id="sync1" class="owl-carousel">
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product1.jpg" class="img-responsive img-center"></div>
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product2.jpg" class="img-responsive img-center"></div>
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product3.jpg" class="img-responsive img-center"></div>
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product4.jpg" class="img-responsive img-center"></div>
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product5.jpg" class="img-responsive img-center"></div>
                        <div class="item"><img alt="" src="https://askbootstrap.com/preview/osahan-fashion/images/women/large/product6.jpg" class="img-responsive img-center"></div>
                     </div>
               ...
               <div class="shop-detail-right">
                  <div class="widget">
                     <div class="product-name">
                        ...
                        <h1>SayItLoud Men Black Solid Round Neck T-shirt</h1>
                     ...
                     <div class="product-variation">
                        <form action="#" method="post">
                           ...
                           <div class="input-group quantity-input">
                              ...
                              <input type="text" name="quant[1]" class="text-center form-control border-form-control form-control-sm input-number" value="0001" min="1" max="10">
                              <span class="input-group-btn">
                     ...
                     <div class="product-cart-option">
                        <ul class="list-inline">
                           <li class="list-inline-item"><a href="https://askbootstrap.com/preview/osahan-fashion/wishlist.html"><i class="icofont icofont-heart"></i> <span>Add to Wishlist</span></a></li>
            ...
            <div class="row">
               <div class="col-sm-12 col-md-4">
                  <div class="widget reviews-section-average">
                     ...
                     <h2 class="bold"><span class="text-primary">3.4</span><small> /5</small> <a href="#">View all Reviews</a></h2>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="widget reviews-section-comment mb18">
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image" src="https://askbootstrap.com/preview/osahan-fashion/images/users/1.jpg" class="img-rounded">
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image" src="https://askbootstrap.com/preview/osahan-fashion/images/users/2.jpg" class="img-rounded">
                           <div class="review-block-name"><a href="#"><i class="icofont icofont-ui-user"></i> Jon Smith</a></div>
                           <div class="review-block-date"><i class="icofont icofont-ui-calendar"></i> June 16, 2018 | 5 Day ago</div>
                        </div>
                        <div class="col-sm-9">
                           <div class="review-block-title">
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image" src="https://askbootstrap.com/preview/osahan-fashion/images/users/3.jpg" class="img-rounded">
                           <div class="review-block-name"><a href="#"><i class="icofont icofont-ui-user"></i> Deep Singh</a></div>
                           <div class="review-block-date"><i class="icofont icofont-ui-calendar"></i> July 02, 2018 | 2 Day ago</div>
                        </div>
                        <div class="col-sm-9">
                           <div class="review-block-title">
                              ...
                              Excellent Product <span class="text-success"><i class="icofont icofont-check-circled"></i> Verified Buyer</span>
                           </div>
                     ...
                     <form>
                        ...
                        <div class="row">
                           <div class="col-sm-12 text-right">
                              ...
                              <button type="button" class="btn btn-outline-success btn-lg"> Submit Review </button>
                           </div>
                        </div>
                     </form>
                  </div>
