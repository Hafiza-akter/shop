...
@section('content')
      ...
      <section class="products_page">
         ...
         <div class="category_sidebar">
            ...
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/grid-slider/slider1.jpg" alt="First slide"></a>
            </div>
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/grid-slider/slider2.jpg" alt="First slide"></a>
            </div>
            <div class="item">
            <a href="#"><img class="d-block img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/grid-slider/slider3.jpg" alt="First slide"></a>
            </div>
            </div>	
            </div>
            ...
            <span>John Players <a href="#"><i class="icofont icofont-close-line-circled"></i></a></span>
            <span>X - Small <a href="#"><i class="icofont icofont-close-line-circled"></i></a></span>
            </div>
            <div class="col-lg-6 col-md-6 sort-by-btn pull-right">
            <div class="view-mode pull-right">
            <a class="active" href="{{route('shop')}}"> <i class="fa fa-th-large"></i> </a><a href="{{route('shop.nongrid')}}"> <i class="fa fa-th-list"></i> </a>
            </div>
            ...
            <div class="col-lg-3 col-md-6"><div class="item">
            <div class="h-100">
            ...
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/men/small/1.jpg" alt=""></a>
            </div>
            ...
            </div></div><div class="col-lg-3 col-md-6"><div class="item">
            <div class="h-100">
            <div class="product-item">
            ...
            <div class="product-item-image">
            <span class="like-icon"><a href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/men/small/3.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
            ...
            <div class="product-item-image">
            <span class="like-icon"><a href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/men/small/5.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
            ...
            <div class="product-item-image">
            <span class="like-icon"><a class="active" href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/all-products/small/2.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
            ...
            <div class="product-item-image">
            <span class="like-icon"><a href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/all-products/small/3.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
            ...
            <div class="product-item-image">
            <span class="like-icon"><a href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/all-products/small/5.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
            ...
            <div class="product-item-image">
            <span class="like-icon"><a href="#"> <i class="icofont icofont-heart"></i></a></span>
            <a href="#"><img class="card-img-top img-fluid" src="https://askbootstrap.com/preview/osahan-fashion/images/all-products/small/6.jpg" alt=""></a>
            </div>
            <div class="product-item-body">
            <div class="product-item-action">
            <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="#" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
