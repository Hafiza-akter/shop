                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-check-input ml-2" {{($product->is_feature) ? 'checked' : ''}} type="checkbox" name="featured">
                            </div>
                          </div>
                          ...
                          <div class="col-sm-6">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-check-input ml-2" type="checkbox" name="is_sale" id="is_sale" {{($product->is_sale) ? 'checked' : ''}}>
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <!-- text input -->
                            <div class="form-group" id="discount_percentage">
                              ...
                              <input type="number" class="form-control discount_percentage" name="discount_percentage"  value="{{$product->discount_percentage}}" >
                            </div>
                          </div>
